...
class JsonPipelines(object):
    def __init__(self):
        self.file1 = open('bus8684/crawls/bus8684.json', 'w', encoding='utf-8')
        self.file2 = open('bus8684/crawls/dt8684.json', 'w', encoding='utf-8')
